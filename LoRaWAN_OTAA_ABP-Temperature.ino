...
uint8_t nodeDeviceEUI[8] =  { 0x69, 0xCA, 0x6C, 0x0D, 0x4C, 0x58, 0xB4, 0x4B };
uint8_t nodeAppEUI[8] =     { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
uint8_t nodeAppKey[16] =    { 0x7C, 0x49, 0x05, 0x50, 0x53, 0xE3, 0x89, 0x9B, 0x50, 0x41, 0xF6, 0xAE, 0xFC, 0x03, 0xD4, 0xED };
...
void send_lora_frame(void)
{
  ...
  // Get the integer and decimal values for the floating point value in integer formats
  int temp_int = ( int )temp;
  int temp_dec = ( int )(( temp - temp_int ) * 100 );

  i += sprintf(( char * )m_lora_app_data.buffer, "Temperature: %d.%02d F", temp_int, temp_dec );
